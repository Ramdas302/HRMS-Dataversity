...
var HolidaySchema = require('../../../app/models/holidayHistory');
var HolidayModel = mongoose.model('holidayhistory');


router.post('/addHoliday',function(req,res){
    var HoliadyData = new HolidayModel({
    ...
    HoliadyData.save(function (err, result) {
      if (err) {
        console.error(err);
...
router.get('/getHoliday',function(req,res){
